...
- 每次 AI 响应后自动更新预览，让用户实时看到选择/修改后的文档变化
- 支持随时手动刷新预览
...
### 8. 中英文双语界面
- 界面支持**中文 / English** 双语，点击右上角 **EN / 中文** 按钮一键切换
- 语言选择保存在 `localStorage`，首次访问默认跟随浏览器语言
- AI 对话（欢迎语、提问、选项按钮、生成的文档）跟随所选语言
- 对话未开始前切换语言，待定的欢迎语会立即重译，让新语言用户知道如何开始
